...
static void dial_preview(json_t* j_camp, json_t* j_plan, json_t* j_dlma, json_t* j_dest);
...
//      );
  ...
  switch(dial_mode) {
    ...
    case E_DIAL_MODE_PREVIEW: {
      dial_preview(j_camp, j_plan, j_dlma, j_dest);
    }
    break;
...
static void dial_preview(json_t* j_camp, json_t* j_plan, json_t* j_dlma, json_t* j_dest)
{
  ...
  if((j_camp == NULL) || (j_plan == NULL) || (j_dlma == NULL)) {
