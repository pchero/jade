...
#ifndef BACKEND_SRC_OB_DB_SQL_CREATE_H_
#define BACKEND_SRC_OB_DB_SQL_CREATE_H_

// plan
static const char* g_sql_ob_plan =
"create table if not exists ob_plan( "
...
"create table if not exists ob_dl_list("
...
"create table if not exists ob_dl_list_ma("
...
"create table if not exists ob_destination("
...
"create table if not exists ob_dl_result("
...
"   uuid_dlma       varchar(255),"
"   uuid_dest       varchar(255),"
"   uuid_dl_list    varchar(255),"
...
// dial info
"   dial_channel        varchar(255),"
"   dial_addr           varchar(255),"
"   dial_index          int,"
"   dial_trycnt         int,"
"   dial_timeout        int,"
"   dial_type           int,"
...
#endif /* BACKEND_SRC_OB_DB_SQL_CREATE_H_ */
