...
static bool db_delete_table_chat_message(const char* table_name)
{
  ...
  // execute
  ret = resource_exec_jade_sql(drop_table);
  sfree(drop_table);
  if(ret == false) {
...
static json_t* db_get_chat_userroom_info(const char* uuid)
{
  ...
  j_res = resource_get_jade_detail_item_key_string(DEF_DB_TABLE_CHAT_USERROOM, "uuid", uuid);
  if(j_res == NULL) {
...
static json_t* db_get_chat_userroom_info_by_user_room(const char* uuid_user, const char* uuid_room)
{
  ...
  j_res = resource_get_jade_detail_item_by_obj(DEF_DB_TABLE_CHAT_USERROOM, j_data);
  json_decref(j_data);
  if(j_res == NULL) {
    return NULL;
  }
...
static json_t* db_get_chat_userrooms_info_by_useruuid(const char* user_uuid)
{
  ...
  j_res = resource_get_jade_detail_items_key_string(DEF_DB_TABLE_CHAT_USERROOM, "uuid_user", user_uuid);
  if(j_res == NULL) {
...
static json_t* db_get_chat_userrooms_info_by_roomuuid(const char* uuid_room)
{
  ...
  j_res = resource_get_jade_detail_items_key_string(DEF_DB_TABLE_CHAT_USERROOM, "uuid_room", uuid_room);
  if(j_res == NULL) {
...
static bool db_create_chat_userroom_info(const json_t* j_data)
{
  ...
  // insert info
  ret = resource_insert_jade_item(DEF_DB_TABLE_CHAT_USERROOM, j_data);
  if(ret == false) {
...
static bool db_update_chat_userroom_info(const json_t* j_data)
{
  ...
  // update
  ret = resource_update_jade_item(DEF_DB_TABLE_CHAT_USERROOM, "uuid", j_data);
  if(ret == false) {
...
static bool db_delete_chat_userroom_info(const char* uuid)
{
  ...
  ret = resource_delete_jade_items_string(DEF_DB_TABLE_CHAT_USERROOM, "uuid", uuid);
  if(ret == false) {
...
static bool db_create_chat_room_info(const json_t* j_data)
{
  ...
  // insert info
  ret = resource_insert_jade_item(DEF_DB_TABLE_CHAT_ROOM, j_data);
  if(ret == false) {
...
static json_t* db_get_chat_room_info(const char* uuid)
{
  ...
  j_res = resource_get_jade_detail_item_key_string(DEF_DB_TABLE_CHAT_ROOM, "uuid", uuid);
  if(j_res == NULL) {
...
static json_t* db_get_chat_room_info_by_type_members(const enum EN_CHAT_ROOM_TYPE type, const json_t* j_members)
{
  ...
  j_res = resource_get_jade_detail_item_by_obj(DEF_DB_TABLE_CHAT_ROOM, j_data);
  json_decref(j_data);
  if(j_res == NULL) {
    return NULL;
  }
...
static json_t* db_get_chat_rooms_info_by_useruuid(const char* user_uuid)
{
  ...
  j_res = resource_get_jade_detail_items_by_condtion(DEF_DB_TABLE_CHAT_ROOM, condition);
  sfree(condition);
  if(j_res == NULL) {
...
static bool db_update_chat_room_info(json_t* j_data)
{
  ...
  ret = resource_update_jade_item(DEF_DB_TABLE_CHAT_ROOM, "uuid", j_data);
  if(ret == false) {
    return false;
  }
...
static bool db_delete_chat_room_info(const char* uuid)
{
  ...
  ret = resource_delete_jade_items_string(DEF_DB_TABLE_CHAT_ROOM, "uuid", uuid);
  if(ret == false) {
...
static bool db_create_chat_message_info(const char* table_name, const json_t* j_data)
{
  ...
  // insert info
  ret = resource_insert_jade_item(table_name, j_data);
  if(ret == false) {
    slog(LOG_ERR, "Could not insert chat_room.");
    return false;
  }
...
static json_t* db_get_chat_message_info(const char* table_name, const char* uuid_message)
{
  ...
  j_res = resource_get_jade_detail_item_key_string(table_name, "uuid", uuid_message);
  if(j_res == NULL) {
    return NULL;
  }
...
static json_t* db_get_chat_messages_info_newest(const char* table_name, const char* timestamp, const unsigned int count)
{
  ...
  j_res = resource_get_jade_detail_items_by_condtion(table_name, condition);
  sfree(condition);
